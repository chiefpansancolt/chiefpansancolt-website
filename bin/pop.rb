...
class Pop < Thor::Group
  ...
  def create # rubocop:disable Metrics/AbcSize, Metrics/MethodLength
    ...
    group_entry = ask("Group", limited_to: [
      "Marvel", "Game of Thrones", "Harry Potter", "Star Wars", "Disney", "Fortnite",
      "Pokemon", "Jurrassic Park", "Borderlands"
    ])
    ...
    template "templates/pop_template.tt", "./src/_pops/#{"#{name_entry.gsub(/\s+/, '-').downcase}-#{number_entry}"}.md",
             opts
  end
end
